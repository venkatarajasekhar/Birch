/*=========================================================================
  ...
  Module:    vtkBirchMySQLDatabase.cxx
...
vtkStandardNewMacro(vtkBirchMySQLDatabase)
...
class vtkBirchMySQLDatabaseRegister
{
public:
  vtkBirchMySQLDatabaseRegister()
    {
...
static vtkBirchMySQLDatabaseRegister mySQLDataBaseRegister;
#endif

// ----------------------------------------------------------------------
vtkBirchMySQLDatabase::vtkBirchMySQLDatabase() :
  Private(new vtkBirchMySQLDatabasePrivate())
{
...
// ----------------------------------------------------------------------
void vtkBirchMySQLDatabase::PrintSelf(ostream &os, vtkIndent indent)
{
...
// ----------------------------------------------------------------------
bool vtkBirchMySQLDatabase::IsSupported(int feature)
{
  switch (feature)
    {
...
// ----------------------------------------------------------------------
bool vtkBirchMySQLDatabase::Open( const char* password )
{
  if ( this->IsOpen() )
    {
...
// ----------------------------------------------------------------------
void vtkBirchMySQLDatabase::Close()
{
  if (! this->IsOpen())
    {
    return; // not an error
...
// ----------------------------------------------------------------------
bool vtkBirchMySQLDatabase::IsOpen()
{
  return (this->Private->Connection != NULL);
}

// ----------------------------------------------------------------------
vtkSQLQuery* vtkBirchMySQLDatabase::GetQueryInstance()
{
  vtkBirchMySQLQuery* query = vtkBirchMySQLQuery::New();
  query->SetDatabase(this);
  return query;
}

// ----------------------------------------------------------------------
vtkStringArray* vtkBirchMySQLDatabase::GetTables()
{
...
// ----------------------------------------------------------------------
vtkStringArray* vtkBirchMySQLDatabase::GetRecord(const char *table)
{
...
bool vtkBirchMySQLDatabase::HasError()
{
...
const char* vtkBirchMySQLDatabase::GetLastErrorText()
{
  if (this->Private->Connection)
    {
...
// ----------------------------------------------------------------------
vtkStdString vtkBirchMySQLDatabase::GetURL()
{
  vtkStdString url;
...
// ----------------------------------------------------------------------
bool vtkBirchMySQLDatabase::ParseURL(const char* URL)
{
  std::string urlstr( URL ? URL : "" );
  std::string protocol;
  std::string username;
...
// ----------------------------------------------------------------------
vtkStdString vtkBirchMySQLDatabase::GetColumnSpecification( vtkSQLDatabaseSchema* schema,
                                                       int tblHandle,
                                                       int colHandle )
{
...
// ----------------------------------------------------------------------
vtkStdString vtkBirchMySQLDatabase::GetIndexSpecification( vtkSQLDatabaseSchema* schema,
                                                      int tblHandle,
                                                      int idxHandle,
                                                      bool& skipped )
{
...
bool vtkBirchMySQLDatabase::CreateDatabase( const char* dbName, bool dropExisting = false )
{
  if ( dropExisting )
    {
...
bool vtkBirchMySQLDatabase::DropDatabase( const char* dbName )
{
  vtkStdString queryStr;
