...
#include "vtkBirchMySQLDatabasePrivate.h"
 ...
 * (vtkBirchMySQLBoundParameter) to hold all the information the user
 * passes in.  At execution time, I'll take those parameters and
 * assemble the array of MYSQL_BIND objects that
 * mysql_stmt_bind_param() expects.  The vtkBirchMySQLBoundParameter
 ...
 * vtkBirchMySQLBoundParameter and use that for the data storage by
 * default.  That will still require special-case handling for blobs
 * and strings.
 *
 * The vtkBirchMySQLQueryInternals class will handle the bookkeeping for
...
class vtkBirchMySQLBoundParameter
{
public:
  vtkBirchMySQLBoundParameter() :
...
#define VTK_BIRCH_MYSQL_TYPENAME_MACRO(type,return_type) \
  enum enum_field_types vtkBirchMySQLTypeName(type) \
  { return return_type; }

VTK_BIRCH_MYSQL_TYPENAME_MACRO(signed char, MYSQL_TYPE_TINY);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(unsigned char, MYSQL_TYPE_TINY);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(signed short, MYSQL_TYPE_SHORT);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(unsigned short, MYSQL_TYPE_SHORT);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(signed int, MYSQL_TYPE_LONG);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(unsigned int, MYSQL_TYPE_LONG);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(signed long, MYSQL_TYPE_LONG);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(unsigned long, MYSQL_TYPE_LONG);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(float, MYSQL_TYPE_FLOAT);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(double, MYSQL_TYPE_DOUBLE);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(vtkTypeInt64, MYSQL_TYPE_LONGLONG);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(vtkTypeUInt64, MYSQL_TYPE_LONGLONG);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(const char *, MYSQL_TYPE_STRING);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(char *, MYSQL_TYPE_STRING);
VTK_BIRCH_MYSQL_TYPENAME_MACRO(void *, MYSQL_TYPE_BLOB);

template<typename T>
bool vtkBirchMySQLIsTypeUnsigned(T)
{
  return false;
}

template<>
bool vtkBirchMySQLIsTypeUnsigned<unsigned char>(unsigned char)
{
  return true;
}

template<>
bool vtkBirchMySQLIsTypeUnsigned<unsigned short>(unsigned short)
{
  return true;
}

template<>
bool vtkBirchMySQLIsTypeUnsigned<unsigned int>(unsigned int)
{
  return true;
}

template<>
bool vtkBirchMySQLIsTypeUnsigned<unsigned long>(unsigned long)
{
  return true;
}

template<>
bool vtkBirchMySQLIsTypeUnsigned<vtkTypeUInt64>(vtkTypeUInt64)
{
  return true;
}
...
// Description:
// This function will build and populate a vtkBirchMySQLBoundParameter
// struct.  The default implementation works for POD data types (char,
// int, long, etc).  I'll need to special-case strings and blobs.

template<typename T>
vtkBirchMySQLBoundParameter *vtkBuildBoundParameter(T data_value)
{
  vtkBirchMySQLBoundParameter *param = new vtkBirchMySQLBoundParameter;

  param->IsNull = false;
  param->IsUnsigned = vtkBirchMySQLIsTypeUnsigned(data_value);
  param->DataType =   vtkBirchMySQLTypeName(data_value);
...
template<>
vtkBirchMySQLBoundParameter *vtkBuildBoundParameter<const char *>(const char *data_value)
{
  vtkBirchMySQLBoundParameter *param = new vtkBirchMySQLBoundParameter;
...
vtkBirchMySQLBoundParameter *vtkBuildBoundParameter(const char *data,
...
class vtkBirchMySQLQueryInternals
{
public:
  vtkBirchMySQLQueryInternals();
  ~vtkBirchMySQLQueryInternals();
  ...
  bool SetBoundParameter(int index, vtkBirchMySQLBoundParameter *param);
...
public:
  ...
  typedef vtksys_stl::vector<vtkBirchMySQLBoundParameter *> ParameterList;
  ParameterList UserParameterList;
};

// ----------------------------------------------------------------------

vtkBirchMySQLQueryInternals::vtkBirchMySQLQueryInternals()
  : Statement(NULL),
    Result(NULL),
...
void vtkBirchMySQLQueryInternals::FreeResult()
{
  if (this->Result)
    {
...
void vtkBirchMySQLQueryInternals::FreeStatement()
{
  if (this->Statement)
    {
...
bool vtkBirchMySQLQueryInternals::SetQuery(const char *queryString,
                                      MYSQL *db,
                                      vtkStdString &error_message)
{
  ...
  if (this->Statement == NULL)
    {
    error_message = vtkStdString("vtkBirchMySQLQuery: mysql_stmt_init returned out of memory error");
    return false;
    }
...
void vtkBirchMySQLQueryInternals::FreeUserParameterList()
{
...
void vtkBirchMySQLQueryInternals::FreeBoundParameters()
{
...
bool vtkBirchMySQLQueryInternals::SetBoundParameter(int index, vtkBirchMySQLBoundParameter *param)
{
...
bool vtkBirchMySQLQueryInternals::BindParametersToStatement()
{
  if (this->Statement == NULL)
    {
...
bool vtkBirchMySQLQueryInternals::ValidPreparedStatementSQL(const char *query)
{
  if ( ! query )
    return false;
...
vtkStandardNewMacro(vtkBirchMySQLQuery);

// ----------------------------------------------------------------------

vtkBirchMySQLQuery::vtkBirchMySQLQuery()
{
  this->Internals = new vtkBirchMySQLQueryInternals;
...
void
vtkBirchMySQLQuery::PrintSelf(ostream  &os, vtkIndent indent)
{
...
vtkBirchMySQLQuery::Execute()
{
  ...
  vtkBirchMySQLDatabase *dbContainer =
    static_cast<vtkBirchMySQLDatabase *>(this->Database);
...
// ----------------------------------------------------------------------
bool vtkBirchMySQLQuery::BeginTransaction()
{
  this->SetQuery( "START TRANSACTION" );
  return this->Execute();
}

bool vtkBirchMySQLQuery::CommitTransaction()
{
  this->SetQuery( "COMMIT" );
  return this->Execute();
}

bool vtkBirchMySQLQuery::RollbackTransaction()
{
...
int
vtkBirchMySQLQuery::GetNumberOfFields()
{
  if (! this->Active)
    {
...
const char *
vtkBirchMySQLQuery::GetFieldName(int column)
{
  if (! this->Active)
    {
...
int
vtkBirchMySQLQuery::GetFieldType(int column)
{
  if (! this->Active)
    {
...
vtkVariant
vtkBirchMySQLQuery::DataValue(vtkIdType column)
{
...
const char *
vtkBirchMySQLQuery::GetLastErrorText()
{
...
bool
vtkBirchMySQLQuery::HasError()
{
  return (this->GetLastErrorText() != NULL);
}

vtkStdString vtkBirchMySQLQuery::EscapeString( vtkStdString src, bool addSurroundingQuotes )
{
  vtkStdString dst;
  vtkBirchMySQLDatabase* dbContainer =
    static_cast<vtkBirchMySQLDatabase*>( this->Database );
...
bool
vtkBirchMySQLQuery::SetQuery(const char *newQuery)
{
  ...
  if (!dbContainer)
    {
    vtkErrorMacro(<< "SetQuery: No database connection set!  This usually happens if you have instantiated vtkBirchMySQLQuery directly.  Don't do that.  Call vtkSQLDatabase::GetQueryInstance instead.");
    return false;
    }
...
bool vtkBirchMySQLQuery::BindParameter(int index, unsigned char value)
{
...
bool vtkBirchMySQLQuery::BindParameter(int index, signed char value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, unsigned short value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, signed short value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, unsigned int value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, signed int value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, unsigned long value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, signed long value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, vtkTypeUInt64 value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, vtkTypeInt64 value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, float value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, double value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, const char *value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkBirchMySQLQuery::BindParameter(int index, const vtkStdString &value)
{
...
bool vtkBirchMySQLQuery::BindParameter(int index, const char *data, size_t length)
{
...
bool vtkBirchMySQLQuery::BindParameter(int index, const void *data, size_t length)
{
...
bool vtkBirchMySQLQuery::ClearParameterBindings()
{
