/*=========================================================================
  ...
  Module:    vtkBirchMySQLDatabase.h
...
-------------------------------------------------------------------------*/
// .NAME vtkBirchMySQLDatabase - maintain a connection to a MySQL database
//
// .SECTION Description
//
...
#ifndef __vtkBirchMySQLDatabase_h
#define __vtkBirchMySQLDatabase_h

#include "vtkSQLDatabase.h"

class vtkSQLQuery;
class vtkBirchMySQLQuery;
class vtkStringArray;
class vtkBirchMySQLDatabasePrivate;

class vtkBirchMySQLDatabase : public vtkSQLDatabase
{
//BTX
  friend class vtkBirchMySQLQuery;
//ETX

public:
  vtkTypeMacro(vtkBirchMySQLDatabase, vtkSQLDatabase);
  void PrintSelf(ostream& os, vtkIndent indent);
  static vtkBirchMySQLDatabase *New();
...
//BTX
  vtkBirchMySQLDatabasePrivate* const Private;
//ETX

  vtkBirchMySQLDatabase(const vtkBirchMySQLDatabase &); // Not implemented.
  void operator=(const vtkBirchMySQLDatabase &); // Not implemented.
};

#endif // __vtkBirchMySQLDatabase_h
